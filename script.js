...
class Game
{
    ...
    set_boxes(BOARD_ID, INFO_ID, DO_ACTION_ID, END_TURN_ID, DIALOGUE_BOX_ID)
    {
        this.html_board = document.getElementById(BOARD_ID);
        this.info = document.getElementById(INFO_ID);
        this.do_action_html = document.getElementById(DO_ACTION_ID);
        this.end_turn_html = document.getElementById(END_TURN_ID);
        this.dialogue_box_html = document.getElementById(DIALOGUE_BOX_ID);
        this.info.style.width = this.INFO_WIDTH + "px";
        this.do_action_html.style.width = this.INFO_WIDTH + "px";
        this.end_turn_html.style.width = this.INFO_WIDTH + "px";
        this.dialogue_box_html.style.width = this.INFO_WIDTH + "px";
        this.info.style.left = (this.BOARD_PIXEL_WIDTH + 50) + "px";
        this.do_action_html.style.left = (this.BOARD_PIXEL_WIDTH + 50) + "px";
        this.end_turn_html.style.left = (this.BOARD_PIXEL_WIDTH + 50) + "px";
        this.dialogue_box_html.style.left = (this.BOARD_PIXEL_WIDTH + 50) + "px";
        this.info.style.height = this.BOARD_PIXEL_HEIGHT/2 + "px";
        this.do_action_html.style.height = this.TURN_BUTTON_HEIGHT + "px";
        this.end_turn_html.style.height = this.TURN_BUTTON_HEIGHT + "px";
        this.dialogue_box_html.style.height = this.TURN_BUTTON_HEIGHT + "px";
        this.do_action_html.style.top = this.BOARD_PIXEL_HEIGHT/2+50 + "px";
        this.end_turn_html.style.top = this.BOARD_PIXEL_HEIGHT/2+95+this.TURN_BUTTON_HEIGHT + "px";
        this.dialogue_box_html.style.top = this.BOARD_PIXEL_HEIGHT/2+140+this.TURN_BUTTON_HEIGHT*2 + "px";
        this.do_action_html.setAttribute("onclick", this.OBJECT_NAME + ".do_all_actions()")
        this.end_turn_html.setAttribute("onclick", this.OBJECT_NAME + ".end_turn()")
        this.info.style.display = "none";
    }
    reset_ui()
    {
...
boards.push(new Board("wwwwwl0cowllwsl0alwllwwll1cs1allswmlwllwwllwllwsllwwwww2al2co", 7, 7, 3, "Images/board_images/Channel.png", "Channel"));
